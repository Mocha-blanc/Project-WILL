...
public class Salameche extends Agent{

	public static final int DETECTION=5;

	public Salameche(int life, Map m){
	...
	//Deplacement intelligent n=nom de l'agent ciblé, i=iteration maximum detectable, ne pas mettre trop d'iteration car fonction tres gourmand, provoque des comutations sur mac si delai trop court  
