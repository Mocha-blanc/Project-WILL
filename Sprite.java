...
public class Sprite {
	...
	public Sprite(){
		...
		try{
			...
			//salamecheSprite
			salamecheSprite[Agent.NORD][0] = ImageIO.read(new File("salameche1.png"));
			salamecheSprite[Agent.NORD][1] = ImageIO.read(new File("salameche1.png"));
			salamecheSprite[Agent.NORD][2] = ImageIO.read(new File("salameche1.png"));
			salamecheSprite[Agent.NORD][3] = ImageIO.read(new File("salameche1.png"));
			salamecheSprite[Agent.NORD][4] = ImageIO.read(new File("salameche1.png"));
			
			salamecheSprite[Agent.EST][0] = ImageIO.read(new File("salameche2.png"));
			salamecheSprite[Agent.EST][0] = ImageIO.read(new File("salameche2.png"));
			salamecheSprite[Agent.EST][0] = ImageIO.read(new File("salameche2.png"));
			salamecheSprite[Agent.EST][0] = ImageIO.read(new File("salameche2.png"));
			salamecheSprite[Agent.EST][0] = ImageIO.read(new File("salameche2.png"));
			
			salamecheSprite[Agent.SUD][0] = ImageIO.read(new File("salameche3.png"));
			salamecheSprite[Agent.SUD][0] = ImageIO.read(new File("salameche3.png"));
			salamecheSprite[Agent.SUD][0] = ImageIO.read(new File("salameche3.png"));
			salamecheSprite[Agent.SUD][0] = ImageIO.read(new File("salameche3.png"));
			salamecheSprite[Agent.SUD][0] = ImageIO.read(new File("salameche3.png"));
			
			salamecheSprite[Agent.WEST][0] = ImageIO.read(new File("salameche4.png"));
			salamecheSprite[Agent.WEST][0] = ImageIO.read(new File("salameche4.png"));
			salamecheSprite[Agent.WEST][0] = ImageIO.read(new File("salameche4.png"));
			salamecheSprite[Agent.WEST][0] = ImageIO.read(new File("salameche4.png"));
			salamecheSprite[Agent.WEST][0] = ImageIO.read(new File("salameche4.png"));
