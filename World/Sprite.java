...
public class Sprite {
	...
	private Image carabaffeSprite[][];
	private Image tortankSprite[][];
	
	private Image bulbizarreSprite[][];
	private Image herbizarreSprite[][];
	private Image florizarreSprite[][];
	...
	public Sprite(){
		...
		carabaffeSprite=new Image[4][3];
		tortankSprite=new Image[4][3];
		
		bulbizarreSprite=new Image[4][3];
		herbizarreSprite=new Image[4][3];
		florizarreSprite=new Image[4][3];
		try{
			//Oeuf
			...
			//Carabaffe
			carabaffeSprite[Agent.NORD][0]= ImageIO.read(new File("carabaffenorth3.png"));
			carabaffeSprite[Agent.NORD][1]= ImageIO.read(new File("carabaffenorth2.png"));
			carabaffeSprite[Agent.NORD][2]= ImageIO.read(new File("carabaffenorth1.png"));
			
			carabaffeSprite[Agent.EST][0]= ImageIO.read(new File("carabaffeeast3.png"));
			carabaffeSprite[Agent.EST][1]= ImageIO.read(new File("carabaffeeast2.png"));
			carabaffeSprite[Agent.EST][2]= ImageIO.read(new File("carabaffeeast1.png"));
			
			carabaffeSprite[Agent.SUD][0]= ImageIO.read(new File("carabaffesouth3.png"));
			carabaffeSprite[Agent.SUD][1]= ImageIO.read(new File("carabaffesouth2.png"));
			carabaffeSprite[Agent.SUD][2]= ImageIO.read(new File("carabaffesouth1.png"));
			
			carabaffeSprite[Agent.WEST][0]= ImageIO.read(new File("carabaffewest3.png"));
			carabaffeSprite[Agent.WEST][1]= ImageIO.read(new File("carabaffewest2.png"));
			carabaffeSprite[Agent.WEST][2]= ImageIO.read(new File("carabaffewest1.png"));
		
			//Tortank
			tortankSprite[Agent.NORD][0]= ImageIO.read(new File("tortanknorth3.png"));
			tortankSprite[Agent.NORD][1]= ImageIO.read(new File("tortanknorth2.png"));
			tortankSprite[Agent.NORD][2]= ImageIO.read(new File("tortanknorth1.png"));
			
			tortankSprite[Agent.EST][0]= ImageIO.read(new File("tortankeast3.png"));
			tortankSprite[Agent.EST][1]= ImageIO.read(new File("tortankeast2.png"));
			tortankSprite[Agent.EST][2]= ImageIO.read(new File("tortankeast1.png"));
			
			tortankSprite[Agent.SUD][0]= ImageIO.read(new File("tortanksouth3.png"));
			tortankSprite[Agent.SUD][1]= ImageIO.read(new File("tortanksouth2.png"));
			tortankSprite[Agent.SUD][2]= ImageIO.read(new File("tortanksouth1.png"));
			
			tortankSprite[Agent.WEST][0]= ImageIO.read(new File("tortankwest3.png"));
			tortankSprite[Agent.WEST][1]= ImageIO.read(new File("tortankwest2.png"));
			tortankSprite[Agent.WEST][2]= ImageIO.read(new File("tortankwest1.png"));
			
			//Bulbizarre
			bulbizarreSprite[Agent.NORD][0]= ImageIO.read(new File("bulbinorth3.png"));
			bulbizarreSprite[Agent.NORD][1]= ImageIO.read(new File("bulbinorth2.png"));
			bulbizarreSprite[Agent.NORD][2]= ImageIO.read(new File("bulbinorth1.png"));

			bulbizarreSprite[Agent.WEST][0]= ImageIO.read(new File("bulbiwest3.png"));
			bulbizarreSprite[Agent.WEST][1]= ImageIO.read(new File("bulbiwest2.png"));
			bulbizarreSprite[Agent.WEST][2]= ImageIO.read(new File("bulbiwest1.png"));
			
			bulbizarreSprite[Agent.SUD][0]= ImageIO.read(new File("bulbisouth3.png"));
			bulbizarreSprite[Agent.SUD][1]= ImageIO.read(new File("bulbisouth2.png"));
			bulbizarreSprite[Agent.SUD][2]= ImageIO.read(new File("bulbisouth1.png"));
			
			bulbizarreSprite[Agent.EST][0]= ImageIO.read(new File("bulbieast3.png"));
			bulbizarreSprite[Agent.EST][1]= ImageIO.read(new File("bulbieast2.png"));
			bulbizarreSprite[Agent.EST][2]= ImageIO.read(new File("bulbieast1.png"));
			
			//Herbizarre
			herbizarreSprite[Agent.NORD][0]= ImageIO.read(new File("herbinorth3.png"));
			herbizarreSprite[Agent.NORD][1]= ImageIO.read(new File("herbinorth2.png"));
			herbizarreSprite[Agent.NORD][2]= ImageIO.read(new File("herbinorth1.png"));
			
			herbizarreSprite[Agent.WEST][0]= ImageIO.read(new File("herbiwest3.png"));
			herbizarreSprite[Agent.WEST][1]= ImageIO.read(new File("herbiwest2.png"));
			herbizarreSprite[Agent.WEST][2]= ImageIO.read(new File("herbiwest1.png"));
			
			herbizarreSprite[Agent.SUD][0]= ImageIO.read(new File("herbisouth3.png"));
			herbizarreSprite[Agent.SUD][1]= ImageIO.read(new File("herbisouth2.png"));
			herbizarreSprite[Agent.SUD][2]= ImageIO.read(new File("herbisouth1.png"));
			
			herbizarreSprite[Agent.EST][0]= ImageIO.read(new File("herbieast3.png"));
			herbizarreSprite[Agent.EST][1]= ImageIO.read(new File("herbieast2.png"));
			herbizarreSprite[Agent.EST][2]= ImageIO.read(new File("herbieast1.png"));
			
			//Florizarre
			florizarreSprite[Agent.NORD][0]= ImageIO.read(new File("florinorth3.png"));
			florizarreSprite[Agent.NORD][1]= ImageIO.read(new File("florinorth2.png"));
			florizarreSprite[Agent.NORD][2]= ImageIO.read(new File("florinorth1.png"));
			
			florizarreSprite[Agent.WEST][0]= ImageIO.read(new File("floriwest3.png"));
			florizarreSprite[Agent.WEST][1]= ImageIO.read(new File("floriwest2.png"));
			florizarreSprite[Agent.WEST][2]= ImageIO.read(new File("floriwest1.png"));
			
			florizarreSprite[Agent.SUD][0]= ImageIO.read(new File("florisouth3.png"));
			florizarreSprite[Agent.SUD][1]= ImageIO.read(new File("florisouth2.png"));
			florizarreSprite[Agent.SUD][2]= ImageIO.read(new File("florisouth1.png"));
			
			florizarreSprite[Agent.EST][0]= ImageIO.read(new File("florieast3.png"));
			florizarreSprite[Agent.EST][1]= ImageIO.read(new File("florieast2.png"));
			florizarreSprite[Agent.EST][2]= ImageIO.read(new File("florieast1.png"));
			//Terrain
	...
	public void affichageStarter(int i,Graphics2D g2, JFrame frame,Starter a){
		...
		}else if(a.getName().equals("carabaffe") ){
			if(a.getMove()==true){
				if(Agent.NORD==a.getDirection())
					g2.drawImage(carabaffeSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.EST==a.getDirection())
					g2.drawImage(carabaffeSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.SUD==a.getDirection())
					g2.drawImage(carabaffeSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.WEST==a.getDirection())
					g2.drawImage(carabaffeSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}else {
				g2.drawImage(carabaffeSprite[a.getDirection()][2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}
		}else if(a.getName().equals("tortank") ){
			if(a.getMove()==true){
				if(Agent.NORD==a.getDirection())
					g2.drawImage(tortankSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.EST==a.getDirection())
					g2.drawImage(tortankSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.SUD==a.getDirection())
					g2.drawImage(tortankSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.WEST==a.getDirection())
					g2.drawImage(tortankSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}else {
				g2.drawImage(tortankSprite[a.getDirection()][2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}
		}
		if(a.getName().equals("bulbizarre") ){
			if(a.getMove()==true){
				if(Agent.NORD==a.getDirection())
					g2.drawImage(bulbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.EST==a.getDirection())
					g2.drawImage(bulbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.SUD==a.getDirection())
					g2.drawImage(bulbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.WEST==a.getDirection())
					g2.drawImage(bulbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}else {
				g2.drawImage(bulbizarreSprite[a.getDirection()][2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}
		}else if(a.getName().equals("florizarre") ){
			if(a.getMove()==true){
				if(Agent.NORD==a.getDirection())
					g2.drawImage(florizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.EST==a.getDirection())
					g2.drawImage(florizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.SUD==a.getDirection())
					g2.drawImage(florizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.WEST==a.getDirection())
					g2.drawImage(florizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}else {
				g2.drawImage(florizarreSprite[a.getDirection()][2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}
		}else if(a.getName().equals("herbizarre") ){
			if(a.getMove()==true){
				if(Agent.NORD==a.getDirection())
					g2.drawImage(herbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.EST==a.getDirection())
					g2.drawImage(herbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.SUD==a.getDirection())
					g2.drawImage(herbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength+(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
				if(Agent.WEST==a.getDirection())
					g2.drawImage(herbizarreSprite[a.getDirection()][i%2], World.spriteLength*a.getX()+World.X*World.spriteLength-(i*World.spriteLength)/4-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}else {
				g2.drawImage(herbizarreSprite[a.getDirection()][2], World.spriteLength*a.getX()+World.X*World.spriteLength-10*World.spriteLength/20,World.spriteLength*a.getY()+World.Y*World.spriteLength-10*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,World.spriteLength+20*World.spriteLength/20,frame);
			}
		} 
